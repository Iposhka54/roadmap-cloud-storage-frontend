                ...
                <Box sx={{p: 1, pb: 4}}>
                    ...
                    >
                        ...
                        <Typography variant="caption" color="text.secondary" sx={{display: 'block', mt: 1}}>
                            Текущий тариф: {currentTariff || '—'} • Текущий лимит: {formatSize(storageInfo?.totalSpace || 0)}
                        </Typography>
                    </Card>
                                ...
                                return (
                                    <Card
                                        ...
                                        sx={{
                                            ...
                                            background: isCurrent
                                                ? 'linear-gradient(180deg, rgba(28,50,163,0.16) 0%, rgba(16,113,195,0.08) 100%)'
                                                : 'header',
                                            backdropFilter: 'blur(10px)',
                                            WebkitBackdropFilter: 'blur(10px)',
                                            boxShadow: 4,
                                    ...
                                    >
                                        ...
                                        <Typography variant="body2" color="text.secondary" sx={{mb: 2}}>
                                            {tariffDescriptions[item.tariff]}
                                        </Typography>
                                        ...
                                        <Box sx={{mt: 'auto'}}>
                                            ...
                                            <Typography variant="h4" sx={{fontSize: '30px', fontWeight: 800, mb: 1.5}}>
                                            ...
                                            <Button
                                                ...
                                                disabled={isCurrent || changingTariff}
                                                onClick={() => changeTariff(item.tariff)}
                                            >
